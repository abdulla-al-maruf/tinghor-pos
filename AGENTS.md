# AGENTS.md — Tinghor POS Project Guide

> এই file টা Codex সবসময় পড়বে। কোনো কিছু করার আগে এখানের rules follow করবে।
...
**Project path:** "S:\Gemini\Tinghor Codex  awstore"
